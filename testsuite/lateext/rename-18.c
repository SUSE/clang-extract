/* { dg-options "-DCE_EXTRACT_FUNCTIONS=ossl_cms_RecipientInfo_kari_init -DCE_MACRO_EXTERNALIZATION -DCE_LATE_EXTERNALIZE -DCE_EXPORT_SYMBOLS=CMS_RecipientEncryptedKey_it,CMS_RecipientKeyIdentifier_it,CMS_KeyAgreeRecipientInfo_it" }*/
